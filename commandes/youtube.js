...
zokou({
  ...
  if (!arg[0]) {
    repondre("insert video name Ie. _video hozambee by shifura._");
    return;
  }
...
\n\n\n ©𝚂𝙸𝚁 *𝙹𝙰𝙼𝙴𝚂*`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "©𝗚𝗟𝗘𝗡 𝗕𝗢𝗧", gifPlayback: false }, { quoted: ms });
      });
