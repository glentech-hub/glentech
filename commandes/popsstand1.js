...
zokou({
  ...
  for (let _0x398282 of _0x115598) {
    ...
    await _0x4cdb8c.sendMessage(_0x398282, {
      'image': {
        'url': "https://files.catbox.moe/eb57ey.jpg"
      },
      'caption': '' + _0x25a35f
    });
  }
...
zokou({
  ...
  try {
    ...
    for (let _0x269fcd of _0x267c2d) {
      ...
      let _0x5838c2 = _0x269fcd.name || _0x269fcd.notify || "[𝗚𝗟𝗘𝗡 𝗕𝗢𝗧] +" + _0x23a8f8;
      _0x4a6ecd += "BEGIN:VCARD\nVERSION:3.0\nFN:" + _0x5838c2 + "\nTEL;type=CELL;type=VOICE;waid=" + _0x23a8f8 + ':+' + _0x23a8f8 + "\nEND:VCARD\n";
    }
    await _0x2e5b52("A moment, *𝗚𝗟𝗘𝗡 𝗕𝗢𝗧* is compiling " + _0x267c2d.length + " contacts into a vcf...");
